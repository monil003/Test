...
function mapReduce(error, record, runtime, render, email, search, task, format) {
    ...
    function getInputData(inputContext) {
        try {
            ...
            var selectedPurchaseOrder = JSON.parse(curScriptObj.getParameter({ name: 'custscript_tc_script_object' }));
            ...
            if (!purchaseOrderID.isIFOrder) {
                ...
                if (createIF) {
                    ...
                    if (itemFulfillmentRec) {
                        ...
                        var endCustomerEmail = load_sales_order.getValue("custbody_tc_end_customer_contact_email");
    ...
    function updateIF(obj) {
        try {
            ...
            const endCustomerEmail = load_sales_order.getValue("custbody_tc_end_customer_contact_email");
